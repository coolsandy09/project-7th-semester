...
<section id="top-sale">
    <div class="container py-5" style="color:#123C69">
        <h4 class="font-rubik font-size-20" style="font-weight:bold; color:white">Upcoming Songs</h4>
        <hr>
        <!-- owl carousel -->
        <div class="owl-carousel owl-theme" style="font-weight:bold">
        <?php foreach ($product_shuffle as $item) if (($item['item_release']=='N/A')&&($item['item_type']=='Song')){ ?> 
            <div class="item py-2">
