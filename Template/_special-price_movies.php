...
<section id="special-price">
    <div class="container">
        <h4 class="font-rubik font-size-20" style="color:white; font-weight:bold">Our Movies Library</h4>
            ...
            <div class="grid-item <?php echo $item['item_brand'] ?? "DefaultVal" ; ?> <?php echo $item['item_brand2'] ?>">
                <div class="item py-2" style="width: 222px;">
                    <div class="product font-rale">
                        <a href="<?php printf('%s?item_id=%s', 'product_movies.php',  $item['item_id']); ?>"><img src="<?php echo $item['item_image'] ?? "./assets/products/13.png"; ?>" alt="product1" class="img-fluid"></a>
